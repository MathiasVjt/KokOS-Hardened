# KokOS DEVELOPMENT/DESKTOP

# Arch Linux Calamares Installer or KokOS
...
When testing out the KokOS in virtualbox, you can use the alias
...
Internet is NOT required for KokOS. Calamares is only using the internet to check where you live to put the red dot correctly on the world map (geoip). Calamares will **not download anything**.
